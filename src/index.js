        ...
        <MDBContainer>
          <nav class="navbar navbar-expand-lg navbar-dark primary-color">
            ...
            <MDBCol md="9" className="mb-r">
                <h2 className="text-uppercase my-3">27.12.19:</h2>
                <div id="events">
                ...
                <MDBCol xl="3" md="6" className="mx-auto text-center">
                    <MDBBtn color="indigo" rounded onClick={this.toggleModal}>
                    Add Event
            ...
            <MDBCol md="3">
                ...
                <h6 className="my-3">
                It is going to be lassy that today. You have{" "}
                <b>{this.state.events.length} events </b> today.
                </h6>
                <h1 className="my-3">
                    <MDBRow>
                    <MDBCol xs="3" className="text-center">
                        <MDBIcon icon="snowflake" fixed />
                    </MDBCol>
                    <MDBCol xs="9">Sunnyss</MDBCol>
                    </MDBRow>
                    <MDBRow>
                    <MDBCol xs="3" className="text-center">
                    <MDBIcon icon="thermometer-three-quarters" fixed />
                    </MDBCol>
                    <MDBCol xs="9">-15°C</MDBCol>
                    </MDBRow>
                </h1>
                <p>
                Don't forget your warm hats.Today weather will becoming cold in the afternoon with temperatures of between -10 and -17 degrees.
                </p>
            </MDBCol>
            </MDBRow>
        </MDBContainer>
